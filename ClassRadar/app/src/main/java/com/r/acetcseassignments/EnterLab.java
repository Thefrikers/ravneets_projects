...
public class EnterLab extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener {
    Spinner block;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enter_lab);
                            ...
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if(avail.equals("true")){
                                        databaseReference1.child(uid).setValue("L@"+str);
                                        ...
                                        Toast.makeText(getApplicationContext(),"Lab occupied!",Toast.LENGTH_SHORT).show();
                                    }
                                }
