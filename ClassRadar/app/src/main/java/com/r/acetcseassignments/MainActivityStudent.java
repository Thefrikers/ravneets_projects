...
public class MainActivityStudent extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v==classes){
            ...
            startActivity(new Intent(getApplicationContext(), FindClasses.class),options.toBundle());
        }
        if(v==labs){
            Pair pairs[]=new Pair[1];
            pairs[0]=new Pair<View,String>(labs,"img1");
            ActivityOptions options=ActivityOptions.makeSceneTransitionAnimation(this,pairs);
            startActivity(new Intent(getApplicationContext(),FindLabs.class),options.toBundle());
        }
        if(v==more){
                            ...
                            AuthUI.getInstance()
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            editor.clear();
                                            editor.commit();
                                            startActivity(new Intent(MainActivityStudent.this, Signin.class));
