...
public class NameActivityTeacher extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_name_teacher);
        ...
        storageReference = FirebaseStorage.getInstance().getReference().child("Teacher_Images");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                sr.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        imgUrl = uri.toString();
                        TeacherInfo teacherInfo = new TeacherInfo(email,name,imgUrl,"Teacher");
                        databaseReference.child(user.getUid()).setValue(teacherInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Intent intent=new Intent(NameActivityTeacher.this, Signin.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(NameActivityTeacher.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void onClick(View v) {
        if (v == buttonSave) {
            ...
            else if (editTextPassword.getText().toString().equals("1234567")) {
               registerUser();
            } else {
